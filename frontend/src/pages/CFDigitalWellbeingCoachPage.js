...
// Digital wellbeing coach: Continuous monitoring of screen time, app usage, focus patterns; AI recommends digital detox intervals, break timing, app usage limits
import React, { useState } from 'react';

export default function CFDigitalWellbeingCoachPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-digital-wellbeing-coach/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Digital wellbeing coach</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Digital wellbeing coach: Continuous monitoring of screen time, app usage, focus patterns; AI recommends digital detox intervals, break timing, app usage limits</p>
